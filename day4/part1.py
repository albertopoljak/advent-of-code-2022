...
for assignment_line in assignment_lines:
    ...
    if second_assignment_start >= first_assignment_start and second_assignment_end <= first_assignment_end:
        total_reconsideration_count += 1
    elif first_assignment_start >= second_assignment_start and first_assignment_end <= second_assignment_end:
        total_reconsideration_count += 1
